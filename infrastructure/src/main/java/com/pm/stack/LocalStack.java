...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id,final StackProps props) {
        ...
        this.vpc  = createVpc();
        DatabaseInstance db = createDatabase("PatientServiceDB","patient-service-db");
        DatabaseInstance authdb = createDatabase("AuthServiceDB","auth-service-db");

        CfnHealthCheck dbHealthCheck = createDbHealthCheck(db,"PatientServiceDBHealthCheck");
        CfnHealthCheck authdbHealthCheck = createDbHealthCheck(authdb,"AuthServiceDBHealthCheck");
        ...
        authService.getNode().addDependency(authdb);
        ...
        patientService.getNode().addDependency(db);
        patientService.getNode().addDependency(dbHealthCheck);
    ...
    private DatabaseInstance createDatabase(String id,String dbname){
        return DatabaseInstance.Builder
                ...
                .allocatedStorage(20)
                .credentials(
                        Credentials.fromGeneratedSecret("admin_user")
                )
                .databaseName(dbname)
    ...
    public static void main(final String[] args) {
       ...
       app.synth();
       System.out.println("LocalStack is running");
